...
import { LayoutDashboard, ShoppingBag, MessageSquare, LogOut, Info } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <NavLink to="/about-section" className={navLinkClasses}>
          <Info size={20} className="mr-3" /> About Section
        </NavLink>
      </nav>
      <div className="p-4 border-t border-slate-200">
        <button
          onClick={handleLogout}
          className="flex items-center w-full px-4 py-2.5 text-left text-slate-600 rounded-md hover:bg-slate-100 text-sm font-medium"
        >
